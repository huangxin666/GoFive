...
bool CChildView::isFourContinueVar1(int direction[])
{
 ...
 // 00 00
bool CChildView::isFourContinueVar2(int direction[])
{
	int flag=0;
	int startFlag=0;
	for(int i=0;i<9;++i){
...
// 00 0||0 00
bool CChildView::isThreeContinueVar(int direction[])
{
	int flag=0;
	int startFlag=0;
	for(int i=0;i<9;++i){
...
//0X || X0)
bool CChildView::isOneToOne(int direction[])
{
	if(direction[3]==-1&&direction[2]==0&&direction[5]==0)
		return true;
	else if(direction[5]==-1&&direction[6]==0&&direction[3]==0)
		return true;
	return false;
}
